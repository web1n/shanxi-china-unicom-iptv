...
cate_list = {
    ...
    "卫视": [
        ...
        "东方卫视", "四川卫视", "黑龙江卫视", "广东卫视", "深圳卫视", "深圳卫视电视剧", "江苏卫视", "浙江卫视", "河北卫视",
        "吉林卫视", "厦门卫视", "广西卫视", "云南卫视", "青海卫视", "内蒙古卫视", "东南卫视", "宁夏卫视", "陕西卫视",
        "甘肃卫视", "农林卫视",
    ],
    "人文": [
        "北京纪实科教", "金鹰纪实", "纪实人文", "环球旅游", "国学频道", "百姓健康", "书画频道", "法治天地", "中华特产",
        "中国天气", "生态环境", "快乐垂钓", "四海钓鱼", "金色学堂", "乐游", "生活时尚", "都市剧场", "环球奇观",
        "车迷频道", "汽摩频道", "游戏风云", "魅力足球", "先锋乒羽", "天下收藏", "武术世界", "文物宝库", "梨园频道"
    ],
    "动漫": [
        "优漫卡通", "卡酷少儿", "金鹰卡通", "嘉佳卡通", "哈哈炫动", "动漫秀场", "优优宝贝", "新动漫"
    ],
    "财经": [
        "东方财经", "财富天下", "家庭理财", "证券服务",
    ],
    "购物": [
        "太原-伯乐购", "茶频道", "优购物","聚鲨环球精选", "家有购物", "央广购物", "好享购物", "CCTV-中视购物",
    ],
    "其他": [
